...
Indices_Leaf_Allsites_Shallow$FDis_SLA <- as.numeric(Indices_Leaf_Allsites_Shallow$FDis_SLA)
...
Indices_Leaf_Fixed_Shallow$FDis_SLA <- as.numeric(Indices_Leaf_Fixed_Shallow$FDis_SLA)
...
Indices_Leaf_SpecificMinusFixedA_Shallow$FDis_SLA <- as.numeric(Indices_Leaf_SpecificMinusFixedA_Shallow$FDis_SLA)
...
png(
  "output_plot/SLA_TakePatternsApart.jpg",
  width = 13,
  height = 8,
  units = 'in',
  res = 300
...
boxplot(FDis_SLA ~ Exposure_Depth, data = Shallow_All_Leaf,
        boxwex = 0.5, col = c("bisque","azure2","grey","bisque","azure2","grey","bisque","azure2","grey","bisque","azure2","grey"),
        at = c(1,2,3, 5,6,7, 9,10,11, 13,14,15),
        main = NA,
