...
Site1_exp_deepB$Height <- Site1_exp_deepB$Height - as.numeric(c("194.1","87.5", "77.7"))
...
Site1_exp_shallowB$Height <- Site1_exp_shallowB$Height - as.numeric(c("200.4","194.1", "87.5", "77.7"))
...
Site2_exp_deepB$Height <- Site2_exp_deepB$Height - as.numeric(c("55.5"))
...
Site2_exp_shallowB$Height <- Site2_exp_shallowB$Height - as.numeric(c("44.2","87.5", "77.7", "55.5"))
...
Site3_exp_deepB$Height <- Site3_exp_deepB$Height - as.numeric(c("194.1","87.5", "77.7", "55.5"))
...
Site3_exp_shallowB$Height <- Site3_exp_shallowB$Height - as.numeric(c("194.1","44.2","87.5", "77.7"))
...
Site4_exp_deepB$Height <- Site4_exp_deepB$Height - as.numeric(c("200.4","87.5", "55.5"))
...
Site4_exp_shallowB$Height <- Site4_exp_shallowB$Height - as.numeric(c("200.4","194.1","44.2","87.5", "77.7", "55.5"))
...
Site5_exp_shallowB$Height <- Site5_exp_shallowB$Height - as.numeric(c("200.4","44.2","87.5", "77.7"))
...
Indices_exp2_deep$CWM <- c(rep("0",8))
...
Site1_semi_deepB$Height <- Site1_semi_deepB$Height - as.numeric(c("200.4","44.2", "87.5", "77.7"))
...
Site1_semi_shallowB$Height <- Site1_semi_shallowB$Height - as.numeric(c("200.4","194.1","44.2", "87.5", "77.7"))
...
Site2_semi_deepB$Height <- Site2_semi_deepB$Height - as.numeric(c("200.4","194.1", "87.5", "77.7"))
...
Site2_semi_shallowB$Height <- Site2_semi_shallowB$Height - as.numeric(c("194.1","44.2", "87.5", "77.7"))
...
Site3_semi_deepB$Height <- Site3_semi_deepB$Height - as.numeric(c("66.5","200.4"))
...
Site3_semi_shallowB$Height <- Site3_semi_shallowB$Height - as.numeric(c("66.5","200.4", "194.1", "87.5"))
...
Site4_semi_deepB$Height <- Site4_semi_deepB$Height - as.numeric(c("66.5","200.4", "44.2"))
...
Site4_semi_shallowB$Height <- Site4_semi_shallowB$Height - as.numeric(c("66.5","200.4", "194.1","32.6", "87.5"))
...
Site5_semi_deepB$Height <- Site5_semi_deepB$Height - as.numeric(c("66.5","200.4", "194.1","87.5","77.7", "55.5"))
...
Site5_semi_shallowB$Height <- Site5_semi_shallowB$Height - as.numeric(c("200.4", "194.1","171.2","87.5","77.7"))
...
Sites_shelB$Height <- Sites_shelB$Height - as.numeric(c("18.4","66.5", "9.3", "190.1", "200.4","44.3", "194.1", "32.6", "87.5"))
...
Sites_pojoB$Height <- Sites_pojoB$Height-  as.numeric(c("18.4","66.5", "15.4", "9.3", "190.1", "200.4","44.3", "34.2", "31.0", "10.7",
                                                        "32.6", "50.1"))
...
Indices_height_SpecificMinusFixedA<- rbind.data.frame(Indices_height_Expsites,Indices_height_Semisites,Indices_height_Pojosites,Indices_height_Shelsites)
Indices_height_SpecificMinusFixedA$Site_number<- c(rep("1S",8),rep("2S",5),rep("3S",6),rep("4S",6),rep("5S",6),rep("1D",8),rep("2D",6),rep("3D",6),rep("4D",6),
...
Indices_height_SpecificMinusFixedA$Exposure_Depth <- factor(paste(Indices_height_SpecificMinusFixedA$Exposure, 
                                                                  Indices_height_SpecificMinusFixedA$Depth, sep = "_"),
                                                 levels = c(
...
Indices_height_SpecificMinusFixedA$Site_Exposure <- factor(paste(Indices_height_SpecificMinusFixedA$Site_number, 
                                                      Indices_height_SpecificMinusFixedA$Exposure, sep = "_"),
                                                levels = c(
