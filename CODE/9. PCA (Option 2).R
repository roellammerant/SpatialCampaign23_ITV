...
Sites_exp_PC1 <-aggregate(x=TraitData_expP$PC1, by=list(TraitData_expP$Site_number,TraitData_expP$Depth, TraitData_exp$Species), FUN=median)
names(Sites_exp_PC1)[1:4]<-paste(c("Site","Depth","Species", "PC1"))

Sites_exp_PC2 <-aggregate(x=TraitData_expP$PC2, by=list(TraitData_expP$Site_number,TraitData_expP$Depth, TraitData_exp$Species), FUN=median)
...
Indices_exp2_PC1D$CWM <- c(rep("0.4419271",8))
...
Indices_exp2_PC2D <- Indices_exp1_PC2S
Indices_exp2_PC2D$FDis <- c(rep("0",8))
Indices_exp2_PC2D$CWM <- c(rep("0.1306418",8))
...
Sites_semi_PC1 <-aggregate(x=TraitData_semiP$PC1, by=list(TraitData_semiP$Site_number,TraitData_semiP$Depth, TraitData_semi$Species), FUN=median)
names(Sites_semi_PC1)[1:4]<-paste(c("Site","Depth","Species", "PC1"))

Sites_semi_PC2 <-aggregate(x=TraitData_semiP$PC2, by=list(TraitData_semiP$Site_number,TraitData_semiP$Depth, TraitData_semi$Species), FUN=median)
...
Indices_PCA_Semisites <-rbind.data.frame(CWMSemi1PC1S,CWMSemi2PC1S,CWMSemi3PC1S,CWMSemi4PC1S,CWMSemi5PC1S,
                                          CWMSemi1PC1D,CWMSemi2PC1D,CWMSemi3PC1D,CWMSemi4PC1D,CWMSemi4PC1D)
...
Indices_PCA_AllsitesB$Site_number<- c(rep("1S",8),rep("2S",5),rep("3S",6),rep("4S",6),rep("5S",6),rep("1D",8),rep("2D",6),rep("3D",6),rep("4D",6),
