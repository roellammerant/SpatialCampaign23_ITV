...
Site4_exp_LAPDB[nrow(Site4_exp_LAPDB) + 1, 1] = c("0.0109054015")
...
Indices_exp2_SLAD$CWM <- c(rep("0.03609",8))
...
Indices_exp2_LAPD$CWM <- c(rep("0.0344133",8))
...
Indices_Leaf_SpecificMinusFixedB<- rbind.data.frame(Indices_leaf_Expsites,Indices_leaf_Semisites,Indices_Leaf_pojosites,Indices_Leaf_shelsites)
Indices_Leaf_SpecificMinusFixedB$Site_number<- c(rep("1S",8),rep("2S",5),rep("3S",6),rep("4S",6),rep("5S",6),rep("1D",8),rep("2D",6),rep("3D",6),rep("4D",6),
...
Indices_Leaf_SpecificMinusFixedB$Exposure_Depth <- factor(paste(Indices_Leaf_SpecificMinusFixedB$Exposure, 
                                                                Indices_Leaf_SpecificMinusFixedB$Depth, sep = "_"),
                                                          levels = c(
...
Indices_Leaf_SpecificMinusFixedB$Site_Exposure <- factor(paste(Indices_Leaf_SpecificMinusFixedB$Site_number, 
                                                               Indices_Leaf_SpecificMinusFixedB$Exposure, sep = "_"),
                                                         levels = c(
