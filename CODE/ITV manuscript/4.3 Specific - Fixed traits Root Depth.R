...
Sites_exp <- aggregate(x=TraitData_expA$RootDepth, by=list(TraitData_expA$`Site number`,TraitData_expA$Depth, TraitData_expA$Species), FUN=max)
names(Sites_exp)[1:4] <- paste(c("Site","Depth","Species", "RootDepth"))
...
names(Site1_exp_deepB)[1]<-paste(c("RootDepth"))
Site1_exp_deepB$RootDepth <- Site1_exp_deepB$RootDepth - as.numeric(c("26.9", "21.8", "40.3"))
...
names(Site1_exp_shallowB)[1]<-paste(c("RootDepth"))
Site1_exp_shallowB$RootDepth <- Site1_exp_shallowB$RootDepth - 
  as.numeric(c("33.8","26.2", "21.8","40.3"))
...
names(Site2_exp_deepB)[1]<-paste(c("RootDepth"))
Site2_exp_deepB$RootDepth <- Site2_exp_deepB$RootDepth -  as.numeric(c("21.1"))
...
names(Site2_exp_shallowB)[1]<-paste(c("RootDepth"))
Site2_exp_shallowB$RootDepth <- Site2_exp_shallowB$RootDepth - 
  as.numeric(c("24.6","21.6", "40.3","21.1"))
...
names(Site3_exp_deepB)[1]<-paste(c("RootDepth"))
Site3_exp_deepB$RootDepth <- Site3_exp_deepB$RootDepth - 
  as.numeric(c("26.9","21.8", "40.3","21.1"))
...
names(Site3_exp_shallowB)[1]<-paste(c("RootDepth"))
Site3_exp_shallowB$RootDepth <- Site3_exp_shallowB$RootDepth - 
  as.numeric(c("26.9","24.6", "21.8","40.3"))

Site4_exp_deep <- subset(Sites_exp, Site==4 & Depth=="D")
Site4_exp_deepB <- as.data.frame(Site4_exp_deep[,c(4)])
Site4_exp_deepB[nrow(Site4_exp_deepB) + 1, 1] = c("8.2")
Site4_exp_deepB <- as.data.frame(Site4_exp_deepB[c(3,1,2),])
names(Site4_exp_deepB)[1]<-paste(c("RootDepth"))
rownames(Site4_exp_deepB)[1:3] <- c("MYRSPI", "STUPEC", "ZOSMAR")
Site4_exp_deepB$RootDepth <- as.numeric(Site4_exp_deepB$RootDepth) - as.numeric(c("33.8","21.8","21.1"))
...
names(Site4_exp_shallowB)[1]<-paste(c("RootDepth"))
Site4_exp_shallowB$RootDepth <- Site4_exp_shallowB$RootDepth - 
  as.numeric(c("33.8","26.9", "24.6","21.8","40.3", "21.1"))
...
Site5_exp_shallowB$RootDepth <- Site5_exp_shallowB$RootDepth - 
  as.numeric(c("33.8","24.6", "21.8","40.3"))
...
Indices_exp2_deep$CWM <- c(rep("-11.2",8))
...
Indices_RootDepth_Expsites <-rbind.data.frame(CWMExp1S,CWMExp2S,CWMExp3S,CWMExp4S,CWMExp5S,
...
Indices_RootDepth_Expsites$FDis_RootDepth <-rbind.data.frame(FDisExp1S,FDisExp2S,FDisExp3S,FDisExp4S,FDisExp5S,
...
Sites_semi <-aggregate(x=TraitData_semiA$RootDepth, by=list(TraitData_semiA$`Site number`,TraitData_semiA$Depth, TraitData_semiA$Species), FUN=median)
names(Sites_semi)[1:4]<-paste(c("Site","Depth","Species", "RootDepth"))
...
names(Site1_semi_deepB)[1]<-paste(c("RootDepth"))
Site1_semi_deepB$RootDepth <- Site1_semi_deepB$RootDepth - 
  as.numeric(c("33.8","24.6", "21.8","40.3"))
...
names(Site1_semi_shallowB)[1]<-paste(c("RootDepth"))
Site1_semi_shallowB$RootDepth <- Site1_semi_shallowB$RootDepth - 
  as.numeric(c("33.8","26.9","24.6", "21.8","40.3"))
...
names(Site2_semi_deepB)[1]<-paste(c("RootDepth"))
Site2_semi_deepB$RootDepth <- Site2_semi_deepB$RootDepth - 
  as.numeric(c("33.8","26.9", "21.8","40.3"))
...
names(Site2_semi_shallowB)[1]<-paste(c("RootDepth"))
Site2_semi_shallowB$RootDepth <- Site2_semi_shallowB$RootDepth - 
  as.numeric(c("26.9","24.6", "21.8","40.3"))
...
names(Site3_semi_deepB)[1]<-paste(c("RootDepth"))
Site3_semi_deepB$RootDepth <- Site3_semi_deepB$RootDepth - 
  as.numeric(c("0.0","33.8"))
...
names(Site3_semi_shallowB)[1]<-paste(c("RootDepth"))
Site3_semi_shallowB$RootDepth <- Site3_semi_shallowB$RootDepth - 
  as.numeric(c("0.0","33.8", "26.9","21.8"))
...
names(Site4_semi_deepB)[1]<-paste(c("RootDepth"))
Site4_semi_deepB$RootDepth <- Site4_semi_deepB$RootDepth - 
  as.numeric(c("0.0","33.8","24.6"))
...
names(Site4_semi_shallowB)[1]<-paste(c("RootDepth"))
Site4_semi_shallowB$RootDepth <- Site4_semi_shallowB$RootDepth - 
  as.numeric(c("0.0","33.8", "26.9","31.5", "21.8"))
...
names(Site5_semi_deepB)[1]<-paste(c("RootDepth"))
Site5_semi_deepB$RootDepth <- Site5_semi_deepB$RootDepth - 
  as.numeric(c("0.0","33.8","26.9", "21.8","40.3", "21.1"))
...
Site5_semi_shallowB$RootDepth <- Site5_semi_shallowB$RootDepth - 
  as.numeric(c("33.8","26.9", "16.5","21.8","40.3"))
...
Indices_RootDepth_Semisites <- rbind.data.frame(CWMSemi1S,CWMSemi2S,CWMSemi3S,CWMSemi4S,CWMSemi5S,
...
Indices_RootDepth_Semisites$Exposure <- c(rep("Semi",60))
###### Functional Dispersion
...
Indices_RootDepth_Semisites$FDis_RootDepth <-rbind.data.frame(FDisSemi1S,FDisSemi2S,FDisSemi3S,FDisSemi4S,FDisSemi5S,
...
Indices_RootDepth_SpecificMinusFixedB<- rbind.data.frame(Indices_RootDepth_Expsites,Indices_RootDepth_Semisites,Indices_RootDepth_pojosites,Indices_RootDepth_shelsites)


Indices_RootDepth_SpecificMinusFixedB$Exposure_Depth <- factor(paste(Indices_RootDepth_SpecificMinusFixedB$Exposure, 
                                                                     Indices_RootDepth_SpecificMinusFixedB$Depth, sep = "_"),
                                                     levels = c(
...
Indices_RootDepth_SpecificMinusFixedB$Site_number<- c(rep("1S",8),rep("2S",5),rep("3S",6),rep("4S",6),rep("5S",6),rep("1D",8),rep("2D",6),rep("3D",6),rep("4D",6),
...
Indices_RootDepth_SpecificMinusFixedB$Site_Exposure <- factor(paste(Indices_RootDepth_SpecificMinusFixedB$Site_number, 
                                                                    Indices_RootDepth_SpecificMinusFixedB$Exposure, sep = "_"),
                                                    levels = c(
