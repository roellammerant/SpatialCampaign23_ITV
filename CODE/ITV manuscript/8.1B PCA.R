...
Indices_PCA_Allsites<- rbind.data.frame(Indices_PCA_expsites,Indices_PCA_semisites,Indices_PCA_pojosites,Indices_PCA_shelsites)

Indices_PCA_Allsites$Site_number<- c(rep("1S",8),rep("2S",5),rep("3S",6),rep("4S",6),rep("5S",6),rep("1D",8),rep("2D",6),rep("3D",6),rep("4D",6),
...
Indices_PCA_Allsites$Exposure_Depth <- factor(paste(Indices_PCA_Allsites$Exposure, 
                                                    Indices_PCA_Allsites$Depth, sep = "_"),
                                               levels = c(
...
Indices_PCA_Allsites$Site_Exposure <- factor(paste(Indices_PCA_Allsites$Site_number, 
                                                    Indices_PCA_Allsites$Exposure, sep = "_"),
                                              levels = c(
