...
Sites1_exp_PC1SB$PC1 <- Sites1_exp_PC1SB$PC1 - as.numeric(c("-1.218","-0.117", "-0.365", "-0.936"))
...
Sites2_exp_PC1SB$PC1 <- Sites2_exp_PC1SB$PC1 - as.numeric(c("-0.427","-0.365", "-0.936", "-0.545"))
...
Sites3_exp_PC1SB$PC1 <-Sites3_exp_PC1SB$PC1 - as.numeric(c("-0.117","-0.427","-0.365", "-0.936"))
...
Sites4_exp_PC1SB$PC1 <- Sites4_exp_PC1SB$PC1 - as.numeric(c("-1.218","-0.117","-0.427","-0.365", "-0.936", 
                                                          "-0.545"))
...
Sites5_exp_PC1SB$PC1 <- Sites5_exp_PC1SB$PC1 - as.numeric(c("-1.218","-0.427","-0.365", "-0.936"))
...
Sites1_exp_PC2SB$PC2 <- Sites1_exp_PC2SB$PC2 - as.numeric(c("0.755","-0.263","0.198", "-1.063"))
...
Sites2_exp_PC2SB$PC2 <- Sites2_exp_PC2SB$PC2 - as.numeric(c("-0.675","0.198", "-1.063", "-0.432"))
...
Sites3_exp_PC2SB$PC2 <- Sites3_exp_PC2SB$PC2 - as.numeric(c("-0.263","-0.675","0.198", "-1.063"))
...
Sites4_exp_PC2SB$PC2 <- Sites4_exp_PC2SB$PC2 - as.numeric(c("0.755","-0.263", "-0.675","0.198", "-1.063", "-0.432"))
...
Sites5_exp_PC2SB$PC2 <- Sites5_exp_PC2SB$PC2 - as.numeric(c("0.755","-0.675","0.198", "-1.063"))
...
Sites1_semi_PC1SB$PC1 <- Sites1_semi_PC1SB$PC1 - as.numeric(c("-1.218","-0.117", "-0.427", "-0.365", "-0.936"))
...
Sites2_semi_PC1SB$PC1 <- Sites2_semi_PC1SB$PC1 - as.numeric(c("-0.117", "-0.427", "-0.365", "-0.936"))
...
Sites3_semi_PC1SB$PC1 <- Sites3_semi_PC1SB$PC1 - as.numeric(c("0.915","-1.218","-0.117", "-0.365"))
...
Sites4_semi_PC1SB$PC1 <- Sites4_semi_PC1SB$PC1 - as.numeric(c("0.915","-1.218","-0.117", "0.465", "-0.365"))
...
Sites5_semi_PC1SB$PC1 <- Sites5_semi_PC1SB$PC1 - as.numeric(c("-1.218", "-0.117", "-2.777", "-0.365", "-0.936"))
...
Sites1_semi_PC2SB$PC2 <- Sites1_semi_PC2SB$PC2 - as.numeric(c("0.755","-0.263","-0.675", "0.198", "-1.063"))
...
Sites2_semi_PC2SB$PC2 <- Sites2_semi_PC2SB$PC2 - as.numeric(c("-0.263","-0.675", "0.198", "-1.063"))
...
Sites3_semi_PC2SB$PC2  <- Sites3_semi_PC2SB$PC2  - as.numeric(c("0.416","0.755", "-0.263", "0.198"))
...
Sites4_semi_PC2SB$PC2  <- Sites4_semi_PC2SB$PC2  - as.numeric(c("0.416","0.755",  "-0.263", "0.154","0.198"))
...
Sites5_semi_PC2SB$PC2 <- Sites5_semi_PC2SB$PC2  - as.numeric(c("0.755", "-0.263", "2.454", "0.198", "-1.063"))
...
Sites_shel_PC1$PC1 <- Sites_shel_PC1$PC1 - as.numeric(c("1.047","0.915", "1.516","-0.996", "-1.218", "1.015", "-0.117", "0.465", 
                                                        "-0.365"))
Sites_shel_PC2$PC2 <- Sites_shel_PC2$PC2 - as.numeric(c("0","0.416", "0.075","0.654", "0.755", "0.382", "-0.263", "0.154", 
                                                        "0.198"))
...
Sites_pojo_PC1$PC1 <- Sites_pojo_PC1$PC1 - as.numeric(c("0.915","2.597", "1.516","-0.997", "-1.218", "1.015", "-0.713", "0.285", 
                                                        "0.136","0.464","0.984"))
Sites_pojo_PC2$PC2 <- Sites_pojo_PC2$PC2 - as.numeric(c("0.416","-0.294", "0.075","0.654", "0.755", "0.382", "-1.147", "0.223", 
                                                        "-0.051","0.154","-0.365"))
...
Indices_PCA_SpecificMinusFixedB$Site_number<- c(rep("1S",8),rep("2S",5),rep("3S",6),rep("4S",6),rep("5S",6),
