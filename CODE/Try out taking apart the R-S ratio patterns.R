...
Indices_Ratio_Allsites_Shallow$FDis_Ratio <- as.numeric(Indices_Ratio_Allsites_Shallow$FDis_Ratio)
...
Indices_Ratio_Fixed_Shallow$FDis_Ratio <- as.numeric(Indices_Ratio_Fixed_Shallow$FDis_Ratio)
...
Indices_Ratio_SpecificMinusFixedA_Shallow$FDis_Ratio <- as.numeric(Indices_Ratio_SpecificMinusFixedA_Shallow$FDis_Ratio)
...
Shallow_All_Ratio$Exposure_Depth <- factor(Shallow_All_RootDepth$Exposure_Depth , # Reorder factor levels
...
png(
  "output_plot/Ratio_TakePatternsApart.jpg",
  width = 13,
  height = 8,
  units = 'in',
  res = 300
...
boxplot(FDis_Ratio ~ Exposure_Depth, data = Shallow_All_Ratio,
        boxwex = 0.5, col = c("bisque","azure2","grey","bisque","azure2","grey","bisque","azure2","grey","bisque","azure2","grey"),
        at = c(1,2,3, 5,6,7, 9,10,11, 13,14,15),
        main = NA,
        xlab = NA, ylab = "FDis Ratio",
        lex.order = TRUE, xaxt="n",cex.lab = 1.2)
