...
### change for fixed heights
Sites_exp$Height <- Sites_exp$Height - as.numeric(c("200.4","200.4", "194.1","194.1", "44.2", "87.5", "87.5", "77.7", "77.7","55.5","55.5"))
...
Sites_semi$Height <- Sites_semi$Height - as.numeric(c("66.5","66.5", "200.4", "200.4", "194.1","194.1", "171.2", "32.6", 
                                  "44.2", "44.2","87.5","87.5", "77.7","77.7", "55.5" ))
...
Indices_height_SpecificMinusFixedB<- rbind.data.frame(Indices_height_Expsites,Indices_height_Semisites,Indices_height_Pojosites,Indices_height_Shelsites)
Indices_height_SpecificMinusFixedB$Site_number<- c(rep("1S",8),rep("2S",5),rep("3S",6),rep("4S",6),rep("5S",6),rep("1D",8),rep("2D",6),rep("3D",6),rep("4D",6),
...
Indices_height_SpecificMinusFixedB$Exposure_Depth <- factor(paste(Indices_height_SpecificMinusFixedB$Exposure, 
                                                                 Indices_height_SpecificMinusFixedB$Depth, sep = "_"),
                                                  levels = c(
...
Indices_height_SpecificMinusFixedB$Site_Exposure <- factor(paste(Indices_height_SpecificMinusFixedB$Site_number, 
                                                                 Indices_height_SpecificMinusFixedB$Exposure, sep = "_"),
                                                 levels = c(
