...
Indices_height_Allsites_Shallow$FDis_Height <- as.numeric(Indices_height_Allsites_Shallow$FDis_Height)
library(plyr)
...
Indices_height_Fixed_Shallow$FDis_Height <- as.numeric(Indices_height_Fixed_Shallow$FDis_Height)
...
Indices_height_SpecificMinusFixedA_Shallow$FDis_Height <- as.numeric(Indices_height_SpecificMinusFixedA_Shallow$FDis_Height)
...
png(
  "output_plot/Height_TakePatternsApart.jpg",
  width = 13,
  height = 8,
  units = 'in',
  res = 300
...
boxplot(FDis_Height ~ Exposure_Depth, data = Shallow_All,
        boxwex = 0.5, col = c("bisque","azure2","grey","bisque","azure2","grey","bisque","azure2","grey","bisque","azure2","grey"),
        at = c(1,2,3, 5,6,7, 9,10,11, 13,14,15),
        main = NA,
        xlab = NA, ylab = "FDis Height",
        lex.order = TRUE, xaxt="n",cex.lab = 1.2)
