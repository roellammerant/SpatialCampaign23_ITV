...
Sites_exp_PC1$PC1 <- as.numeric(c("1.12","0.19", "0.19","0.34", "0.09", "0.09", "0.93", 
                                  "0.93", "0.40","0.40"))
Sites_exp_PC2$PC2 <- as.numeric(c("0.57","-0.28", "-0.28","-0.59", "0.18", "0.18", "-0.84", 
                                  "-0.84", "0.11","0.11"))
...
Sites_semi_PC1$PC1 <- as.numeric(c("-1.29","-1.29", "1.12","1.12", "0.19","0.19", "2.62", "-0.65", "0.34", 
                                   "0.34","0.09","0.09","0.93","0.93","0.40"))
Sites_semi_PC2$PC2 <- as.numeric(c("0.22","0.22", "0.57","0.57", "-0.28","-0.28", "2.81", "-0.06", "0.59", 
...
Sites_shel_PC1$PC1 <- as.numeric(c("-0.92","-1.29", "-1.45","0.88", "1.12", "-1.29", "0.19", "-0.65", 
                                   "0.09"))
Sites_shel_PC2$PC2 <- as.numeric(c("0.01","0.22", "0.04","0.74", "0.57", "0.29", "-0.28", "0.06", 
                                   "0.18"))
...
Sites_pojo_PC1$PC1 <- as.numeric(c("-0.92","-1.29", "-1.29","-1.47", "-1.45", "-1.45", "0.88", "1.12", 
                                   "-1.29","-1.29","1.44","-0.67", "-0.67","0.09", "-0.65", "-0.65", "-0.05"))
Sites_pojo_PC2$PC2 <- as.numeric(c("0.01","0.22", "0.22","0.10", "0.04", "0.04", "0.74", "0.57", 
