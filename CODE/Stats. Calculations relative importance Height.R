...
Indices_height_SpecificMinusFixedB$CWM_Height<- as.numeric(Indices_height_SpecificMinusFixedB$CWM_Height) 
...
Indices_height_SpecificMinusFixedB$FDis_Height<- as.numeric(Indices_height_SpecificMinusFixedB$FDis_Height) 
...
Indices_height_SpecificMinusFixedB$Exposure<- as.factor(Indices_height_SpecificMinusFixedB$Exposure)
...
Indices_height_AllsitesB$CWM_Height<- as.numeric(Indices_height_AllsitesB$CWM_Height) 
Indices_height_AllsitesB$FDis_Height<- as.numeric(Indices_height_AllsitesB$FDis_Height) 
Indices_height_AllsitesB$Exposure<- as.factor(Indices_height_AllsitesB$Exposure) 
...
Indices_height_AllsitesB$FDis_Height[Indices_height_AllsitesB$FDis_Height == 0] <- 0.00001 
Shallow_Height_SpecificB <- Indices_height_AllsitesB[ which(Indices_height_AllsitesB$Depth=='Shallow'), ]
...
CWMHeight_IntraB <- adonis2(Shallow_Height_IntraB$CWM_Height ~ Exposure + Site_Exposure, data=Shallow_Height_IntraB, perm=999)
CWMHeight_IntraB # significant difference at exposure and site level

FDisHeight_IntraB <- adonis2(Shallow_Height_IntraB$FDis_Height ~ Exposure + Site_Exposure , data=Shallow_Height_IntraB, perm=999)
FDisHeight_IntraB # significant difference at exposure and site level
...
CWMHeight_SpecificB <- adonis2(Shallow_Height_SpecificB$CWM_Height ~ Exposure + Site_Exposure, data=Shallow_Height_SpecificB, perm=999)
CWMHeight_SpecificB # significant difference at exposure and site level

FDisHeight_SpecificB <- adonis2(Shallow_Height_SpecificB$FDis_Height ~ Exposure + Site_Exposure , data=Shallow_Height_SpecificB, perm=999)
FDisHeight_SpecificB # significant difference at exposure and site level
